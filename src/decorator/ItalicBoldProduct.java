...
public class ItalicBoldProduct implements Produto{
    private ProdutoFormatado component;

    public ItalicBoldProduct(Produto component) {
    ...
    public String formataParaImpressao() {
		return "<span style=\"font-style: italic; font-weight: bold; color: " + this.component.getCor() + "\">" + this.component.formataParaImpressao() + "</span>";
    }
}
