...
public class BoldProduct implements Produto{

    private ProdutoFormatado component;

    public BoldProduct(Produto component) {
    ...
    public String formataParaImpressao() {
        return "<span style=\"font-weight:bold; color: " + this.component.getCor() + "\">" + this.component.formataParaImpressao() + "</span>";
    }
}
